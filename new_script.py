...
def readLangs(lang1, lang2, reverse=False):
    ...
    lines = open('%s-%s.test' % (lang1, lang2), encoding='utf-8').read().strip().split('\n')
...
##### PREPROCESSING
MAX_LENGTH = 600 # Max sentence length, number of words
...
# Sample pairs
input_lang, output_lang, pairs = prepare_data('diff', 'int', False)
...
train_iters(encoder, attention_decoder, n_iters, print_every=1000)
...
# Test cases
evaluate_and_show_attention('z e i C u C d 1')
